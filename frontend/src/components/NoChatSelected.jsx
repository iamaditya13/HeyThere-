...
const NoChatSelected = () => {
  return (
    <div className="h-full flex flex-col items-center justify-center p-16 bg-gray-700 relative overflow-hidden">
      <div className="max-w-md text-center space-y-8 relative z-10">
        {/* Icon Display */}
        <div className="flex justify-center mb-8">
          <div className="relative">
            <div className="w-24 h-24 rounded-2xl bg-gray-600 flex items-center justify-center border border-gray-500 shadow-lg">
